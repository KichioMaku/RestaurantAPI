...
namespace RestaurantAPI.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public AccountService(RestaurantDbContext context, IPasswordHasher<User> passwordHasher, AutenticationSettings autenticationSettings)
        {
            _context = context;
        ...
        public string GenerateJwt(LoginDto dto)
        {
            ...
            var token = new JwtSecurityToken(_autenticationSettings.JwtIssuer, _autenticationSettings.JwtIssuer,
               claims, 
               expires: expires, 
